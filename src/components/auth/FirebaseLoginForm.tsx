...
/**
 * SDK-backed Firebase sign-in form (Product A shell). FIX-G: this is the
 * lazy inner of FirebaseLoginCard — loaded via next/dynamic ONLY when a
 * hosted login surface renders it, so the firebase SDK never enters Product
 * B's bundle (or B's build output at all).
 */

export type FirebaseLoginFormProps = {
